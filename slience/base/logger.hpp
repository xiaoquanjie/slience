...
{\
	if (base::logger::LOG_LEVEL_TRACE>=GetLogLevel()){\
		base::logger::logimpl(base::logger::LOG_LEVEL_TRACE).stream()<<__FUNCTION__<< "|"<<content;\
	}\
}
...
{\
	if (base::logger::LOG_LEVEL_DEBUG>=GetLogLevel()){\
		base::logger::logimpl(base::logger::LOG_LEVEL_DEBUG).stream()<<__FUNCTION__<< "|"<<content;\
	}\
}
...
{\
	if (base::logger::LOG_LEVEL_INFO>=GetLogLevel()){\
		base::logger::logimpl(base::logger::LOG_LEVEL_INFO).stream()<<__FUNCTION__<< "|"<<content;\
	}\
}
...
{\
	if (base::logger::LOG_LEVEL_WARN>=GetLogLevel()){\
		base::logger::logimpl(base::logger::LOG_LEVEL_WARN).stream()<<__FUNCTION__<< "|"<<content;\
	}\
}
...
{\
	if (base::logger::LOG_LEVEL_ERROR>=GetLogLevel()){\
		base::logger::logimpl(base::logger::LOG_LEVEL_ERROR).stream()<<__FUNCTION__<< "|"<<content;\
	}\
}
...
{\
	if (base::logger::LOG_LEVEL_FATAL>=GetLogLevel()){\
		base::logger::logimpl(base::logger::LOG_LEVEL_FATAL).stream()<<__FUNCTION__<< "|"<<content;\
	}\
}
